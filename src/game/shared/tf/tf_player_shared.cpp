...
ConVar tf_scout_air_dash_count( "tf_scout_air_dash_count", "15", FCVAR_REPLICATED | FCVAR_CHEAT | FCVAR_DEVELOPMENTONLY );
...
ConVar tf_spy_invis_unstealth_time( "tf_spy_invis_unstealth_time", "0.0", FCVAR_DEVELOPMENTONLY | FCVAR_REPLICATED, "Transition time in and out of spy invisibility", true, 0.1, true, 5.0 );
